...
from modules.assemble import SimpleContextAssembler  # Correct import
...
def main():
    ...
    while True:
        ...
        # Assemble context from the prompt
        context = context_assembler.assemble_context(prompt)
        
        # Expand the prompt with the assembled context
        expanded_prompt = context_assembler.expand_prompt(prompt, context)
